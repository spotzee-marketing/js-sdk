...
export type ClientOptions = {
    baseUrl: 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/admin' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | 'https://apix.spotzee.com/api/client' | (string & {});
};
...
/**
 * Where the rule applies — to the user (`user`), an event (`event`), or inherited from the parent wrapper.
 */
...
export type RuleNode = {
    ...
    group: RuleGroup;
    /**
     * Dotted path on the user or event payload. For wrappers, leave empty.
     */
    path: string;
    /**
...
/**
 * A tenant scope inside an organisation. Owns its own users, segments, lists, journeys, and templates.
 */
export type Project = {
    /**
     * Numeric project identifier.
...
export type EventByExternalId = {
    ...
    /**
     * System-of-record identifier of the user this event belongs to.
     */
    external_id: string;
    /**
     * Free-form event payload. Indexed for use in segments and journey conditions.
...
/**
 * Stable, opaque identifier prefixed with `evt_`.
 */
export type EventId = string;

export type EventUser = {
    /**
     * System-of-record user identifier, when available.
     */
    external_id: string | null;
    /**
     * Anonymous tracking identifier, when available.
     */
    anonymous_id: string | null;
};
...
export type EventRecord = {
    ...
    user: EventUser;
    /**
     * Campaign identifier when the event belongs to a campaign.
     */
    campaign_id: number | null;
    /**
     * Event payload. Present when `include_payload=true`.
     */
    data?: {
        [key: string]: unknown;
    };
...
export type EventAggregationRecord = {
    /**
     * Event name when grouped by event.
     */
    event_name?: string;
    /**
     * Campaign identifier when grouped by campaign.
     */
    campaign_id?: number | null;
    user?: EventUser;
    /**
     * Calendar day in UTC when grouped by day.
     */
    day?: string;
    /**
    ...
    count: number;
    /**
     * Number of distinct users represented in the matching events.
     */
    unique_user_count: number;
    /**
     * First matching event time, or `null` when there were no matches.
     */
    first_seen_at: string | null;
    /**
     * Last matching event time, or `null` when there were no matches.
     */
    last_seen_at: string | null;
};

export type EventAggregationResponse = {
    results: Array<EventAggregationRecord>;
    /**
     * Cursor for the next page, or `null` when there is no next page.
     */
    nextCursor: string | null;
 ...
 */
export type EventAggregationGroupBy = 'event_name' | 'campaign' | 'user' | 'day';
...
/**
 * Partial update of a campaign. To send a blast, set `state: "scheduled"` and `send_at`; to cancel, set `state: "aborted"`. If `subscription_id` changes the campaign channel, include a matching `provider_id` in the same request.
 */
...
/**
 * Identifies the user entering the journey.
 */
...
/**
 * Manually trigger a journey entrance for a single user.
 */
export type JourneyTrigger = {
    /**
     * Identifier of the journey entrance step to enter the user at.
     */
    entrance_id: number;
...
export type TemplateEmailData = {
    ...
    subject?: string | null;
    editor?: 'code' | 'visual' | 'plain' | 'wysiwyg';
    /**
     * React Email/TipTap document JSON used by the WYSIWYG editor.
     */
    emailEditorJson?: {
        [key: string]: unknown;
    } | null;
...
export type TemplateInAppData = {
    /**
     * In-app presentation type.
     */
    type: 'banner' | 'alert' | 'html';
    /**
     * In-app message title. Handlebars-templated.
     */
    title: string;
    /**
     * In-app message body. Handlebars-templated.
     */
    body: string;
    /**
    ...
    html?: string | null;
    /**
     * Marks the notification as read once viewed.
     */
    read_on_view?: boolean | null;
    /**
     * Optional image URL for alert-style in-app messages.
     */
    image?: string | null;
    /**
...
/**
 * Data type used to validate and render a CRM property.
 */
export type CrmPropertyDataType = 'string' | 'number' | 'boolean' | 'date' | 'datetime' | 'select' | 'multiselect' | 'reference';

export type CrmPropertyOption = {
    /**
...
/**
 * Public CRM property definition.
 */
export type CrmProperty = {
    /**
     * Numeric CRM property identifier.
     */
    id: number;
    object_type: CrmObjectType;
    /**
     * Stable property key used in CRM `properties` objects.
     */
    key: string;
    /**
     ...
     */
    label: string;
    data_type: CrmPropertyDataType;
    /**
     * Allowed values for select and multiselect properties.
     */
    options?: Array<CrmPropertyOption> | null;
    /**
     * Display group used by Spotzee CRM.
     */
    group?: string | null;
    /**
     * True when the property is part of the default CRM catalogue.
     */
    is_default: boolean;
    /**
     * True when the property is backed by a system field.
     */
    is_system: boolean;
    /**
     * True when Spotzee requires a value for this property.
     */
    is_required: boolean;
    /**
    ...
    /**
     * Public CRM endpoints only expose public CRM properties.
     */
    visibility: 'public';
};

/**
 * CRM property definitions visible to the public CRM API.
 */
export type CrmPropertyList = Array<CrmProperty>;
...
export type CrmContact = {
    /**
     * Numeric CRM contact identifier.
     */
    id: number;
    /**
     * Caller-supplied user identifier, when present.
     */
    external_id?: string | null;
    /**
     * Anonymous tracking identifier, when present.
     */
    anonymous_id?: string | null;
    /**
    ...
    phone?: string | null;
    /**
     * Linked CRM company identifier, when assigned.
     */
    crm_company_id?: number | null;
    /**
     * Current CRM pipeline stage key.
     */
    pipeline_stage?: string | null;
    /**
     * Public CRM property values keyed by property key.
     */
    properties: {
        [key: string]: unknown;
    };
    /**
     * Time the contact was created. ISO 8601.
     */
    created_at: string | null;
    /**
...
/**
 * Paginated CRM contacts response.
 */
export type CrmContacts = {
    results: Array<CrmContact>;
    nextCursor: string | null;
    prevCursor: string | null;
    limit: number;
};
...
/**
 * Direction to walk relative to `cursor`. Defaults to `next`.
 */
export type CrmPageDirection = 'next' | 'prev';

/**
 * Sort direction. Defaults vary by resource.
 */
export type CrmSortDirection = 'asc' | 'desc';

export type CrmContactPropertiesPatch = {
    /**
     * Company to link, or `null` to unlink.
     */
    crm_company_id?: number | null;
    /**
     * Public CRM property values to update.
     */
    properties?: {
        [key: string]: unknown;
    };
...
export type CrmActivityType = 'note' | 'call' | 'email' | 'sms' | 'meeting' | 'task' | 'stage_change';

export type CrmActivityDirection = 'inbound' | 'outbound';

/**
 * Public CRM activity projection.
 */
export type CrmActivity = {
    /**
     * Numeric CRM activity identifier.
     */
    id: number;
    /**
     * Linked CRM contact identifier.
     */
    contact_id?: number | null;
    /**
     * Linked CRM company identifier.
     */
    ...
    /**
     * Task due time, when applicable. ISO 8601.
     */
    due_at?: string | null;
    /**
     * Task completion time, when applicable. ISO 8601.
     */
    completed_at?: string | null;
};

export type CrmContactStageMoveResponse = {
    contact: CrmContact;
    activity: CrmActivity;
};

export type CrmContactStagePatch = {
    /**
     * Pipeline stage key to move the contact to.
     */
    stage_key: string;
};

/**
 * Public CRM company projection.
 */
export type CrmCompany = {
    /**
     * Numeric CRM company identifier.
     */
    id: number;
    /**
     * Company name.
    ...
    name: string;
    /**
     * Company domain, when known.
     */
    domain?: string | null;
    /**
     * Public CRM company property values keyed by property key.
     */
    properties: {
        [key: string]: unknown;
    };
    /**
     * Number of linked contacts, when included.
     */
    contacts_count?: number;
    /**
     * Time the company was created. ISO 8601.
     */
    created_at?: string | null;
    /**
     * Time the company was last modified. ISO 8601.
     */
    updated_at?: string | null;
};

/**
 * Paginated CRM companies response.
 */
export type CrmCompanies = {
    results: Array<CrmCompany>;
    nextCursor: string | null;
    prevCursor: string | null;
    limit: number;
};
...
export type CrmCompanyCreate = {
    ...
    domain?: string | null;
    /**
     * Public CRM company property values.
     */
    properties?: {
        [key: string]: unknown;
    };
...
/**
 * Paginated CRM activities response.
 */
export type CrmActivities = {
    results: Array<CrmActivity>;
    nextCursor: string | null;
    prevCursor: string | null;
    limit: number;
};
...
/**
 * Manual activity type. Stage changes are created by the stage endpoint.
 */
export type CrmManualActivityType = 'note' | 'call' | 'email' | 'sms' | 'meeting' | 'task';

export type CrmActivityCreate = {
    /**
     * CRM contact to attach the activity to.
     */
    contact_id?: number | null;
    /**
     * CRM company to attach the activity to.
     */
    company_id?: number | null;
    ...
    occurred_at?: string | null;
    /**
     * Task due time, when applicable.
     */
    due_at?: string | null;
    /**
     * Task completion time, when applicable.
     */
    completed_at?: string | null;
};
...
export type CrmPipelineStageList = Array<CrmPipelineStage>;

/**
 * Saved CRM view metadata. Public CRM v1 does not expose saved-view rule editing.
 */
export type CrmView = {
    id: number;
    object_type: CrmObjectType;
...
export type CrmViewList = Array<CrmView>;
...
export type AggregateEventsData = {
    ...
    query: {
         ...
         */
        group_by?: Array<EventAggregationGroupBy>;
        /**
         * Opaque cursor returned by a previous page. Omit on the first request.
         */
        cursor?: string;
...
export type AggregateEventsErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type AggregateEventsError = AggregateEventsErrors[keyof AggregateEventsErrors];

export type AggregateEventsResponses = {
    /**
     * A page of event count groups.
     */
    200: EventAggregationResponse;
};

export type AggregateEventsResponse = AggregateEventsResponses[keyof AggregateEventsResponses];
...
export type ListCrmPropertiesData = {
    body?: never;
    path?: never;
    query?: {
        object_type?: CrmObjectType & unknown;
    };
    url: '/crm/properties';
};

export type ListCrmPropertiesErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type ListCrmPropertiesError = ListCrmPropertiesErrors[keyof ListCrmPropertiesErrors];

export type ListCrmPropertiesResponses = {
    /**
...
export type ListCrmPropertiesResponse = ListCrmPropertiesResponses[keyof ListCrmPropertiesResponses];

export type ListCrmContactsData = {
    body?: never;
    path?: never;
    query?: {
        /**
         ...
         */
        cursor?: string;
        page?: CrmPageDirection;
        /**
         * Maximum results per page. Maximum is 100.
         */
        limit?: number;
        /**
         * Field to sort by. Defaults vary by resource.
         */
        sort?: string;
        direction?: CrmSortDirection;
        /**
         * Free-text search across indexed CRM fields.
         */
        q?: string;
        /**
         * Filter contacts by pipeline stage key.
         */
        pipeline_stage?: string;
        /**
         * Filter contacts by linked company identifier.
         */
        crm_company_id?: number;
        /**
         * Apply a saved CRM contact view.
         */
        view_id?: number;
    };
    url: '/crm/contacts';
...
export type ListCrmContactsErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type ListCrmContactsError = ListCrmContactsErrors[keyof ListCrmContactsErrors];

export type ListCrmContactsResponses = {
    /**
     * A page of CRM contacts.
     */
    200: CrmContacts;
};

export type ListCrmContactsResponse = ListCrmContactsResponses[keyof ListCrmContactsResponses];

export type GetCrmContactData = {
    body?: never;
    path: {
        /**
         * Numeric CRM contact identifier.
...
export type GetCrmContactErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type GetCrmContactError = GetCrmContactErrors[keyof GetCrmContactErrors];

export type GetCrmContactResponses = {
    /**
     * The requested CRM contact.
     */
    200: CrmContact;
};

export type GetCrmContactResponse = GetCrmContactResponses[keyof GetCrmContactResponses];

export type UpdateCrmContactPropertiesData = {
    body?: CrmContactPropertiesPatch;
    path: {
        /**
         * Numeric CRM contact identifier.
         */
...
export type UpdateCrmContactPropertiesErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type UpdateCrmContactPropertiesError = UpdateCrmContactPropertiesErrors[keyof UpdateCrmContactPropertiesErrors];

export type UpdateCrmContactPropertiesResponses = {
    /**
     * The updated CRM contact.
     */
    200: CrmContact;
};

export type UpdateCrmContactPropertiesResponse = UpdateCrmContactPropertiesResponses[keyof UpdateCrmContactPropertiesResponses];

export type MoveCrmContactStageData = {
    body?: CrmContactStagePatch;
    path: {
        /**
         * Numeric CRM contact identifier.
         */
...
export type MoveCrmContactStageErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type MoveCrmContactStageError = MoveCrmContactStageErrors[keyof MoveCrmContactStageErrors];

export type MoveCrmContactStageResponses = {
    /**
     * The updated contact and stage-change activity.
     */
    200: CrmContactStageMoveResponse;
};

export type MoveCrmContactStageResponse = MoveCrmContactStageResponses[keyof MoveCrmContactStageResponses];

export type ListCrmCompaniesData = {
    body?: never;
    path?: never;
    query?: {
        /**
...
export type ListCrmCompaniesErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type ListCrmCompaniesError = ListCrmCompaniesErrors[keyof ListCrmCompaniesErrors];

export type ListCrmCompaniesResponses = {
    /**
     * A page of CRM companies.
     */
    200: CrmCompanies;
};

export type ListCrmCompaniesResponse = ListCrmCompaniesResponses[keyof ListCrmCompaniesResponses];

export type CreateCrmCompanyData = {
    body?: CrmCompanyCreate;
    path?: never;
    query?: never;
    url: '/crm/companies';
};
...
export type GetCrmCompanyErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type GetCrmCompanyError = GetCrmCompanyErrors[keyof GetCrmCompanyErrors];

export type GetCrmCompanyResponses = {
    /**
     * The requested CRM company.
     */
    200: CrmCompany;
};

export type GetCrmCompanyResponse = GetCrmCompanyResponses[keyof GetCrmCompanyResponses];

export type UpdateCrmCompanyData = {
    body?: CrmCompanyUpdate;
    path: {
        /**
         * Numeric CRM company identifier.
         */
...
export type UpdateCrmCompanyErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type UpdateCrmCompanyError = UpdateCrmCompanyErrors[keyof UpdateCrmCompanyErrors];

export type UpdateCrmCompanyResponses = {
    /**
     * The updated CRM company.
     */
    200: CrmCompany;
};

export type UpdateCrmCompanyResponse = UpdateCrmCompanyResponses[keyof UpdateCrmCompanyResponses];

export type ListCrmCompanyContactsData = {
    body?: never;
    path: {
        /**
         * Numeric CRM company identifier.
...
export type ListCrmCompanyContactsErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type ListCrmCompanyContactsError = ListCrmCompanyContactsErrors[keyof ListCrmCompanyContactsErrors];

export type ListCrmCompanyContactsResponses = {
    /**
     * A page of linked CRM contacts.
     */
    200: CrmContacts;
};

export type ListCrmCompanyContactsResponse = ListCrmCompanyContactsResponses[keyof ListCrmCompanyContactsResponses];

export type ListCrmCompanyActivitiesData = {
    body?: never;
    path: {
        /**
         * Numeric CRM company identifier.
...
export type ListCrmCompanyActivitiesErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type ListCrmCompanyActivitiesError = ListCrmCompanyActivitiesErrors[keyof ListCrmCompanyActivitiesErrors];

export type ListCrmCompanyActivitiesResponses = {
    /**
     * A page of CRM activities.
     */
    200: CrmActivities;
};

export type ListCrmCompanyActivitiesResponse = ListCrmCompanyActivitiesResponses[keyof ListCrmCompanyActivitiesResponses];

export type ListCrmActivitiesData = {
    body?: never;
    path?: never;
    query?: {
        /**
        ...
        q?: string;
        /**
         * Filter activities by CRM contact identifier.
         */
        contact_id?: number;
        /**
         * Filter activities by CRM company identifier.
         */
        company_id?: number;
    };
    url: '/crm/activities';
...
export type ListCrmActivitiesErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type ListCrmActivitiesError = ListCrmActivitiesErrors[keyof ListCrmActivitiesErrors];
...
export type ListCrmActivitiesResponse = ListCrmActivitiesResponses[keyof ListCrmActivitiesResponses];

export type CreateCrmActivityData = {
...
export type CreateCrmActivityErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type CreateCrmActivityError = CreateCrmActivityErrors[keyof CreateCrmActivityErrors];

export type CreateCrmActivityResponses = {
    /**
     * The created CRM activity.
     */
    201: CrmActivity;
};

export type CreateCrmActivityResponse = CreateCrmActivityResponses[keyof CreateCrmActivityResponses];

export type ListCrmPipelineStagesData = {
    body?: never;
    path?: never;
    query?: never;
...
export type ListCrmPipelineStagesErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type ListCrmPipelineStagesError = ListCrmPipelineStagesErrors[keyof ListCrmPipelineStagesErrors];

export type ListCrmPipelineStagesResponses = {
    /**
     * CRM pipeline stages.
     */
    200: CrmPipelineStageList;
};

export type ListCrmPipelineStagesResponse = ListCrmPipelineStagesResponses[keyof ListCrmPipelineStagesResponses];

export type ListCrmViewsData = {
    body?: never;
    path?: never;
    query?: {
        object_type?: CrmObjectType;
...
export type ListCrmViewsErrors = {
    /**
     * Malformed request — bad parameters, body, or version header.
     */
    400: ErrorResponse;
...
export type ListCrmViewsError = ListCrmViewsErrors[keyof ListCrmViewsErrors];

export type ListCrmViewsResponses = {
    /**
     * CRM saved view metadata.
     */
    200: CrmViewList;
};

export type ListCrmViewsResponse = ListCrmViewsResponses[keyof ListCrmViewsResponses];
